...
*/
function add_categorias(data_id){
 ...
 * Events
 */
$('.categorias_add_btn').click(function(e) {
    e.defaultPrevented;
    add_categorias($(this).data('btn-id'));
});
$('.categorias_add_form input').keypress(function(e) {
    e.defaultPrevented;
    if(e.which == 13) {
        add_categorias($(this).data('form-id'));
